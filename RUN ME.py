#!/usr/bin/env python3
"""
Advanced Folder Locker - Main Entry Point
FIXED: Enhanced with PyQt6 support and better error handling
"""
...
def main():
    ...
    try:
        ...
        print("  • Proper Light and Dark theme support")
...
if __name__ == "__main__":
    print("🔐 ADVANCED FOLDER LOCKER - ENHANCED VERSION")
    print("Enhanced with responsive UI, proper themes, F11 fullscreen, and smart error handling")
    print()
